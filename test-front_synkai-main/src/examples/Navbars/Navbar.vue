...
const logout = async () => {
  try {
    ...
    // Ignorar errores de logout en cliente
    // (por ejemplo si luego se conecta a una API remota)
  } finally {
    // Redirigir a la página principal (ajusta la ruta si usas otra)
    router.push("/");
  }
};
...
<template>
  <nav
    ...
    data-scroll="true"
  >
    <div class="px-2 px-lg-3 py-1 container-fluid flex-wrap">
      <!-- Botón menú sidebar: siempre visible en móvil/tablet (< xl) para abrir el sidenav -->
      <a
        href="#"
        class="d-xl-none p-2 nav-link text-white me-2 rounded"
      ...
      <div
        class="collapse navbar-collapse mt-2 mt-lg-0 me-md-0 me-sm-4"
      ...
      >
        ...
        <ul class="navbar-nav justify-content-end">
          ...
          <li class="nav-item d-none d-xl-flex ps-3 align-items-center">
            <a
              href="#"
              @click.prevent="minimizeSidebar"
